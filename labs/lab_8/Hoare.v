...
Definition assn5 : Assertion := fun st => st X = st Y.
End ExAssertions.
(** [] *)
...
*)
(*
  1) Se c termina, então X tem que ser igual a 5 para ser válido
  2) Para qualquer número natural m, se X é igual a m e c terminar
     então X tem que ser igual a m + 5.
  3) Se X for menor ou igual a Y e c terminar então Y tem que ser menor ou igual a X.
  4) Se c terminar então é inválido, logo não terminar então é válido.
  5) Se X é igual a m e c terminar então y tem que ser igual a real_fact m.
  6) Se X é igual a m e c terminar então Z*Z tem que ser menor ou igual a m
     e o (S Z) * (S Z) tem que sair maior que m.
*)
...
Theorem hoare_post_true : forall (P Q : Assertion) c,
  ...
  {{P}} c {{Q}}.
Proof.
  intros P Q c QTrue st st' H PTrue.
  apply QTrue.
Qed.
(** [] *)
...
Theorem hoare_pre_false : forall (P Q : Assertion) c,
  ...
  {{P}} c {{Q}}.
Proof.
  intros P Q c PFalse st st' H PTrue.
  apply PFalse in PTrue.
  contradiction.
Qed.
(** [] *)
