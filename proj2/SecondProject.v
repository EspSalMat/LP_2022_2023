...
Theorem assume_false: forall P Q b,
       ...
       ({{P}} assume b {{Q}}).
Proof.
  intros P Q b H st r HAssume HP.
  inversion HAssume; subst.
...
Theorem assert_implies_assume : forall P b Q,
  ...
  -> ({{P}} assume b {{Q}}).
Proof.
  intros P b Q H st r HAssume HP.
  inversion HAssume; subst. unfold hoare_triple in H.
...
Proof.
  ...
  eapply multi_step. apply CS_SeqStep. apply CS_NonDetChoice1. eapply multi_step. apply CS_SeqStep. apply CS_AssStep. apply AS_Plus1. apply AS_Id.
  eapply multi_step. apply CS_SeqStep. apply CS_AssStep. apply AS_Plus.
  ...
  simpl. eapply multi_step. apply CS_AssertTrue. eapply multi_refl.
  reflexivity.
Qed.
